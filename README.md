...
- **抽出結果を公表採択数と突き合わせている。** SIGIR 2019=84 / 2020=147 /
  2021=151、WWW 2019=225、RecSys 2019=36 は公表値と完全に一致する。
  一致しない年（RecSys 2023・2024）も原因を特定したうえで、
  それを除外した感度分析を出して結論が動かないことを確認している。
