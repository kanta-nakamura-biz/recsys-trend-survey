...
**検証**: 抽出したフル論文数は各会議の公表採択数とよく一致する
（SIGIR 2019 = 84、SIGIR 2020 = 147、SIGIR 2021 = 151、WWW 2019 = 225、
WSDM 2019 = 84、RecSys 2019 = 36）。
...
4. **RecSys 2023・2024 の内訳が分離できない**。RecSys の Reproducibility トラックは
   2021・2022・2025 では DBLP に独立見出しがあるが、2023・2024 には無い。
   この 2 年は再現性論文が主題別セッションに混在し、フル論文として数えられて
   いる可能性が高い（RecSys 2023 = 53 件、2024 = 71 件にはその分が含まれる）。
